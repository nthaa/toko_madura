...
<base href="../../../" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
		...
		@extends('supplier.supplierTampilan')
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Supplier</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search supplier" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													...
													<i class="ki-duotone ki-plus fs-2"></i>Add Supplier</button>
													<!--end::Add user-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
													...
													<div class="modal-dialog modal-dialog-centered mw-650px">
														...
														<div class="modal-content">
															...
															<div class="modal-body px-5 my-7">
																<!--begin::Form-->
																<form id="ajax-form" method="post" id="kt_modal_add_user_form" class="form" action="{{route('menyimpansupplier')}}">
																@csrf
																	<!--begin::Scroll-->
																	<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<!--begin::Input group-->
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="nama" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama supplier" value="{{old('nama')}}" />
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="toko" class="form-control form-control-solid mb-3 mb-lg-0"  placeholder="Nama Toko"  value="{{old('toko')}}" />
																				<div id="errortoko" class="print-error-msg"></div>
																				@error('toko')
																					<div class="form-text text-danger">{{$message}}</div>
																				<!--end::Input-->
																				@enderror
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<textarea name="alamat" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Alamat">{{old('alamat')}}</textarea>
																				<div id="erroralamat" class="print-error-msg"></div>
																				@error('alamat')
																					<div class="form-text text-danger">{{$message}}</div>
																				<!--end::Input-->
																				@enderror
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="no_telp" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="No. Telp" value="{{old('no_telp')}}" />
																				<div id="errornotelp" class="print-error-msg"></div>
																				@error('no_telp')
																					<div class="form-text text-danger">{{$message}}</div>
																				<!--end::Input-->
																				@enderror
												...
												<div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
													...
													<div class="modal-dialog modal-dialog-centered mw-650px">
														...
														<div class="modal-content">
															<!--begin::Form-->
															<form id="ajax-form-update" method="post" class="form"  id="kt_modal_update_user_form" action="{{route('updatesupplier')}}">
															@csrf	
															<!--begin::Modal header-->
																...
																<div class="modal-body py-10 px-lg-17">
																	...
																	<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_user_header" data-kt-scroll-wrappers="#kt_modal_update_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div id="kt_modal_update_user_user_info" class="collapse show">
																			...
																			<div class="fv-row mb-7">
																				<!--begin::Label-->
																				<label class="required fw-semibold fs-6 mb-2">ID Supplier</label>
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="id_supplier" id="id" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="ID supplier" value="{{old('id')}}" readonly />
																				@error('nama')
																				<div class="form-text text-danger">{{$message}}</div>
																				<!--end::Input-->
																				@enderror
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="nama" id="nama_update" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama supplier" value="{{old('nama')}}" />
																				<div id="errornama" class="print-error-msg"></div>
																				@error('nama')
																				<div class="form-text text-danger">{{$message}}</div>
																				<!--end::Input-->
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="toko" id="toko_update" class="form-control form-control-solid mb-3 mb-lg-0"  placeholder="Nama Toko"  value="{{old('toko')}}" />
																				<div id="errortoko" class="print-error-msg"></div>
																				@error('toko')
																					<div class="form-text text-danger">{{$message}}</div>
																				<!--end::Input-->
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<textarea name="alamat" id="alamat_update" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Alamat">{{old('alamat')}}</textarea>
																				<div id="erroralamat" class="print-error-msg"></div>
																				@error('alamat')
																					<div class="form-text text-danger">{{$message}}</div>
																				<!--end::Input-->
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="no_telp" id="no_telp_update" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="No. Telp" value="{{old('no_telp')}}" />
																				<div id="errornotelp" class="print-error-msg"></div>
																				@error('no_telp')
																					<div class="form-text text-danger">{{$message}}</div>
																				<!--end::Input-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" >
												<thead>
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Id Supplier</th>
														<th class="min-w-125px">Nama</th>
														<th class="min-w-125px">Toko</th>
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													@foreach($supplier as $s)
														<tr>
															<td id="id{{$s->id_supplier}}">{{$s->id_supplier}}
															</td>
															<td>
																<div id="nama{{$s->id_supplier}}">{{$s->nama}}</div>
															</td>
															<td>
																<div id="toko{{$s->id_supplier}}">{{$s->toko}}</div>
															</td>
															<td> 
															...
															<td class="text-end">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																	...
																	<div class="menu-item px-3">
																		<span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit supplier">
																			<a href="#"  class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details" onclick="lempar({{$s->id_supplier}})">Edit</a>
																		</span>
																	</div>
																	<!--end::Menu item-->
																	<!--begin::Menu item-->
																	<div class="menu-item px-3">
																		<a href="#" class="menu-link px-3" data-kt-users-table-filter="delete_row" onclick="javascript:window.open('supplier/hapus/{{$s->id_supplier}}','_self')">Hapus</a>
																	</div>
																	<!--end::Menu item-->
																</div>
																<!--end::Menu-->
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div class="text-center mb-13">
							<h1 class="mb-3">Search Supplier</h1>
	  ...
	  $('#ajax-form-update').submit(function(e) {
        ...
        //    });
	  	...
	  	function lempar(a){
			...
			document.getElementById("nama_update").value=document.getElementById("nama"+a).innerHTML;
			//menggunakan innerHTML karena data yang mau diambil ada didalamnya td atau div
			document.getElementById("toko_update").value=document.getElementById("toko"+a).innerHTML;
			document.getElementById("alamat_update").value=document.getElementById("alamat"+a).innerHTML;
			document.getElementById("no_telp_update").value=document.getElementById("no_telp"+a).innerHTML;
