...
<base href="../../../" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Produk</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search produk" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
													...
													<div class="modal-dialog modal-dialog-centered mw-650px">
														...
														<div class="modal-content">
															...
															<div class="modal-body px-5 my-7">
																<!--begin::Form-->
																<form id="ajax-form" method="post" class="form" action="{{route('menyimpanproduk')}}">
																@csrf
																...
																<!--begin::Scroll-->
																	<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<div class="fv-row mb-7">
																				<!--begin::Label-->
																				<label class="required fw-semibold fs-6 mb-2">ID Produk</label>
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="id_produk" id="" readonly required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="ID Produk" value="{{ old('id_produk') }}"  />
																				<!--end::Input-->
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="nama_produk" id="nama_produk" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama Produk" value="{{ old('nama_produk') }}"  />
																			<!--end::Input-->
																			<div id="errornama" class="print-error-msg"></div>
																			@error('nama')
																				<div>Mohon maaf, field nama tidak boleh kosong</div>
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="harga_beli" id="harga_beli" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Harga Beli" value="{{ old('harga_beli') }}"  />
																			<!--end::Input-->
																			@error('toko')
																				{{ $message }}
																			@enderror
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="harga_jual" id="harga_jual" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Harga Jual" value="{{ old('harga_jual') }}"  />
																			<!--end::Input-->
																			@error('alamat')
																				{{ $message }}
																			@enderror
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="stok" id="stok" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Stok" value="{{ old('stok') }}"  />
																			<!--end::Input-->
																			@error('no_telp')
																				{{ $message }}
																			@enderror
																		...
																		<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<select id="satuan" name="satuan" class="form-select form-select-solid form-select-sm" data-control="select2" data-hide-search="true" data-placeholder="Satuan">
																					<option></option>
                                                                        ...
                                                                        <div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" name="barcode" id="barcode" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Barcode" value="{{ old('barcode') }}"  />
																			<!--end::Input-->
																			@error('no_telp')
																				{{ $message }}
																			@enderror
														...
														<div class="modal-content">
															...
															<!--begin::Modal header-->
																<div class="modal-header" id="kt_modal_update_user_header">
																	<!--begin::Modal title-->
																	<h2 class="fw-bold">Update Produk</h2>
																	<!--end::Modal title-->
																	<!--begin::Close-->
																	<div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
																		<i class="ki-duotone ki-cross fs-1">
																...
																<div class="modal-body py-10 px-lg-17">
																	...
																	<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_user_header" data-kt-scroll-wrappers="#kt_modal_update_user_scroll" data-kt-scroll-offset="300px">
																		<!--begin::User toggle-->
																		<div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#kt_modal_update_user_user_info" role="button" aria-expanded="false" aria-controls="kt_modal_update_user_user_info">Informasi supplier
																		...
																		<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="id_produk" id="id" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="ID Produk" value="{{ old('id_produk') }}"  />
																				<!--end::Input-->
																				<div id="errornama" class="print-error-msg"></div>
																				@error('nama')
																					<div>Mohon maaf, field nama tidak boleh kosong</div>
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="nama_produk" id="nama_produk_update" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama Produk" value="{{ old('nama_produk') }}"  />
																				<!--end::Input-->
																				<div id="errornama" class="print-error-msg"></div>
																				@error('nama')
																					<div>Mohon maaf, field nama tidak boleh kosong</div>
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="harga_beli" id="harga_beli_update" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Harga Beli" value="{{ old('harga_beli') }}"  />
																				<!--end::Input-->
																				@error('toko')
																					{{ $message }}
																				@enderror
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="harga_jual" id="harga_jual_update" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Harga Jual" value="{{ old('harga_jual') }}"  />
																				<!--end::Input-->
																				@error('alamat')
																					{{ $message }}
																				@enderror
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="stok" id="stok_update" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Stok" value="{{ old('stok') }}"  />
																				<!--end::Input-->
																				@error('no_telp')
																					{{ $message }}
																				@enderror
																			...
																			<div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<select id="satuan_update" name="satuan" class="form-select form-select-solid form-select-sm" data-control="select2" data-hide-search="true" data-placeholder="Satuan">
																					<option></option>
																					<option value="pcs">Pcs</option>
																					<option value="karton">Karton</option>
																				</select>
                                                                            ...
                                                                            <div class="fv-row mb-7">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type="text" name="barcode" id="barcode_update" required class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Barcode" value="{{ old('barcode') }}"  />
																				<!--end::Input-->
																				@error('no_telp')
																					{{ $message }}
																				@enderror
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" >
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													@foreach($produk as $produk)
														<tr>
															<td>
																<div id="id{{$produk->id_produk}}">{{$produk->id_produk}}</div>
															</td>
															<td>
																<div id="nama_produk{{$produk->id_produk}}">{{$produk->nama_produk}}</div>
															</td>
															<td>
																<div id="harga_beli{{$produk->id_produk}}">{{$produk->harga_beli}}</div>
															</td>
															<td>
																<div id="harga_jual{{$produk->id_produk}}">{{$produk->harga_jual}}</div>
															</td>
															<td>
																<div id="stok{{$produk->id_produk}}">{{$produk->stok}}</div>
															</td>
                                                            <td>
																<div id="satuan{{$produk->id_produk}}">{{$produk->satuan}}</div>
															</td>
                                                            <td>
															...
															<td class="text-end">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																	...
																	<!--begin::Menu item-->
																	<div class="menu-item px-3">
																		<a class="menu-link px-3" data-kt-users-table-filter="delete_row" onclick="javascript:window.open('produk/hapus/{{$produk->id_produk}}','_self')">Delete</a>
																	</div>
																	<!--end::Menu item-->
																</div>
																<!--end::Menu-->
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div class="text-center mb-13">
							<h1 class="mb-3">Search Produk</h1>
	  ...
	  $('#ajax-form-update').submit(function(e) {
        ...
        //         },
        //         error: function(response){
        //             $('#ajax-form-update').find(".print-error-msg").find("ul").html('');
        //             $('#ajaxform-update').find(".print-error-msg").css('display','block');
        //             $.each( response.responseJSON.errors, function( key, value ) {
        //                 $('#ajax-form-update').find(".print-error-msg").find("ul").append('<li>'+value+'</li>');
        //             });
        //         }
        //    });
      });
	  	...
	  	function lempar(a){
			document.getElementById("id").value=document.getElementById("id"+a).innerHTML;
				...
				document.getElementById("harga_beli_update").value=document.getElementById("harga_beli"+a).innerHTML;
				document.getElementById("harga_jual_update").value=document.getElementById("harga_jual"+a).innerHTML;
				document.getElementById("stok_update").value=document.getElementById("stok"+a).innerHTML;
                document.getElementById("satuan_update").value=document.getElementById("satuan"+a).innerHTML;
                document.getElementById("barcode_update").value=document.getElementById("barcode"+a).innerHTML;
