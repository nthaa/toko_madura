            ...
            <div id="kt_app_footer" class="app-footer">
							...
							<div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
								...
								<div class="text-gray-900 order-2 order-md-1">
									<img src = "assets/media/logos/images.png" style="width: 50px">
									<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">Toko Ampel</a>
								</div>
								<!--end::Copyright-->
								<!--begin::Menu-->
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">SELAMAT DATANG DI TOKO MADURA</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
											...
											<div class="card-body pb-lg-20">
												...
												<div class="mb-13">
													...
													<div class="overlay mb-11">
														<!--begin::Image-->
														<div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-325px" style="background-image:url('assets/media/stock/1600x800/img-3.jpg')"></div>
														<!--end::Image-->
														<!--begin::Links-->
												...
												<div class="row align-items-center mb-10">
													<!--begin::Col-->
													<div class="col-xl-5">
														<img src="assets/media/product/1.svg" class="mw-100 me-15" alt="" />
													</div>
													<!--end::Col-->
													<!--begin::Col-->
													<div class="col-xl-7">
												...
												<div class="m-0">
													...
													<div class="mb-9">
														...
														<!--begin::Title-->
														<!--begin::Description-->
														<span class="fs-5 fw-semibold text-muted">Save thousands to millions of bucks by using single tool for different amazing and great useful admin</span>
														<!--begin::Description-->
													</div>
													<!--end::Heading-->
													<!--begin::Members-->
													<div class="d-flex flex-wrap w-100 mw-xxl-800px">
														...
														<div class="d-flex flex-column text-center mb-11 me-5 me-lg-15">
															...
															<div class="text-center">
																<!--begin::Info-->
																<a href="pages/user-profile/overview.html" class="text-gray-900 fw-bold text-hover-primary fs-4">Paul Miles</a>
																<!--end::Info-->
																<!--begin::Position-->
														...
														<div class="d-flex flex-column text-center mb-11 me-5 me-lg-15">
															...
															<div class="text-center">
																<!--begin::Info-->
																<a href="pages/user-profile/overview.html" class="text-gray-900 fw-bold text-hover-primary fs-4">Melisa Marcus</a>
																<!--end::Info-->
																<!--begin::Position-->
														...
														<div class="d-flex flex-column text-center mb-11 me-5 me-lg-15">
															...
															<div class="text-center">
																<!--begin::Info-->
																<a href="pages/user-profile/overview.html" class="text-gray-900 fw-bold text-hover-primary fs-4">James Nilson</a>
																<!--end::Info-->
																<!--begin::Position-->
														...
														<div class="d-flex flex-column text-center mb-11 me-5 me-lg-15">
															...
															<div class="text-center">
																<!--begin::Info-->
																<a href="pages/user-profile/overview.html" class="text-gray-900 fw-bold text-hover-primary fs-4">Arlene McCoy</a>
																<!--end::Info-->
																<!--begin::Position-->
																<span class="text-muted d-block fw-semibold">Python Expert</span>
																<!--end::Position-->
												...
												<!--end::Team-->
												<!--begin::Team info-->
												<div class="fs-4 fw-semibold text-gray-600 mb-10">First, a disclaimer – the entire process of writing a blog post often takes more than a couple of hours, even if you can type eighty words per minute and your writing skills are sharp. From the seed of the idea to finally hitting “Publish,” you might spend several days or maybe even a week “writing” a blog post, but it’s important to spend those vital hours planning your post and even thinking about 
												<a href="pages/blog/post.html" class="link-primary pe-1">Your Post</a>(yes, thinking counts as working if you’re a blogger) before you actually write it.</div>
												<!--end::Team info-->
												<!--begin::Post-->
												<div class="row align-items-center mb-10">
													<!--begin::Wrapper-->
													<div class="col-lg-7">
														...
														<div class="mb-5 position-relative z-index-3">
															...
															<div class="mb-6">
																<!--begin::Title-->
																<h1 class="fw-bold text-gray-900 fw-bold lh-base">Writing a Great Headline 
																<br />Write an Outline For Your Post</h1>
																<!--end::Title-->
															</div>
															<!--end::Wrapper-->
															<!--begin::Text-->
															<span class="text-gray-700 d-block fw-semibold fs-4 pb-4 lh-lg">The most well thought out design theme I have ever used. The codes are up to tandard. The css styles are amazingly very clean. In fact the cleanest and the most up to standard I have ever seen.</span>
															<!--end::Text-->
															<!--begin::Text-->
															<span class="text-gray-700 fw-semibold fs-4 lh-lg">In fact the cleanest and the most up to standard codes are up to tandard. The css styles are amazingly very clean.</span>
															<!--end::Text-->
														</div>
														<!--end::Content-->
														<!--begin::Item-->
													...
													<div class="col-lg-5">
														<!--begin::Image-->
														<img src="assets/media/svg/illustrations/easy/4.svg" class="w-175px mb-10" alt="" />
														<!--end::Image-->
														<!--begin::Action-->
														<div class="ps-13"></div>
														<!--end::Action-->
										...
										<div class="flex-column flex-lg-row-auto w-100 w-xl-350px">
											...
											<div class="card card-flush bg-body mb-9">
												...
												<div class="card-body">
													...
													<div class="mb-7">
														<!--begin::Title-->
														<h2 class="fs-1 text-gray-800 w-bolder mb-6">Careers</h2>
														<!--end::Title-->
														<!--begin::Text-->
													...
													<!--end::Items-->
													<!--begin::Link-->
													<a href="pages/careers/list.html" class="link-primary fs-6 fw-semibold">Explore More</a>
													<!--end::Link-->
												</div>
												<!--end::Body-->
											</div>
											...
											<div class="card card-flush bg-body mb-9">
												...
												<div class="card-body pt-2">
													...
													<!--end::Item-->
													<!--begin::Link-->
													<a href="pages/blog/home.html" class="text-primary opacity-75-hover pt-8 fs-6 fw-semibold d-block">Explore More</a>
													<!--end::Link-->
												</div>
												<!--end::Card body-->
											</div>
